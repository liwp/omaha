...
const TCHAR* const kRegValueServiceName           = _T("vara_service_name");
const TCHAR* const kRegValueMediumServiceName     = _T("varam_service_name");
const TCHAR* const kRegValueTaskNameC             = _T("vara_task_name_c");
const TCHAR* const kRegValueTaskNameUA            = _T("vara_task_name_ua");
...
const TCHAR* const kServicePrefix               = _T("vara");
const TCHAR* const kMediumServicePrefix         = _T("varam");
