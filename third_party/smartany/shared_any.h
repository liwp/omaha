...
public:
    ...
    pointer_type operator->() const
    {
        ...
        static detail::omaha_static_assert<!detail::is_handle<T>::value> const cannot_dereference_a_handle;
        #endif
        assert( m_held.valid() );
    ...
    {
        static detail::omaha_static_assert<!detail::is_handle<T>::value> const cannot_dereference_a_handle;
        static detail::omaha_static_assert<!detail::is_delete<close_policy>::value> const accessed_like_an_array_but_not_deleted_like_an_array;
        assert( m_held.valid() );
        return m_held.m_t[ i ];
    }
